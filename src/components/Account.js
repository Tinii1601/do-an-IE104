    ...
    <div className="flex bg-[#FFF8F0] p-10 min-h-screen justify-center">
      ...
      <div className="bg-white p-4 rounded-lg shadow-md w-[380px] h-[290px] mr-8">
        ...
        <div className="space-y-2">
          <button
            ...
            className={`block w-full text-left p-2 rounded-full ${
              activeSection === 'accountInfo' ? 'bg-gray-300' : 'bg-white border border-gray-300'
            } hover:bg-gray-100`}
          >
            Thông tin tài khoản
          </button>
          <button
            ...
            className={`block w-full text-left p-2 rounded-full ${
              activeSection === 'orderManagement' ? 'bg-gray-300' : 'bg-white border border-gray-300'
            } hover:bg-gray-100`}
          >
            Quản lý đơn hàng
          </button>
          <button
            ...
            className={`block w-full text-left p-2 rounded-full ${
              activeSection === 'changePassword' ? 'bg-gray-300' : 'bg-white border border-gray-300'
            } hover:bg-gray-100`}
          >
            Đổi mật khẩu
          </button>
      ...
      <div
        className={`flex flex-col bg-white p-8 rounded-lg shadow-md ${
          activeSection === 'changePassword' ? 'w-[1200px] h-[520px]' : 'w-[1200px] h-[830px]'
        }`}
      >
